...
<div class="container">
    ...
    <div class="mb-3 row">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input type="file" class="form-control" id="PostImage" name="PostImage" value="{{ $post->image }}">
        </div>
      </div>
      <div class="mb-3 row">
        <label for="PostContent" class="col-sm-2 col-form-label">Content</label>
        <div class="col-sm-10">
            <textarea class="form-control" id="PostContent" rows="3" name="PostContent">{{ $post->content }}</textarea>
          </div>
      </div>
